...
# Configuración - ajustar ruta según estructura
BASE_PROJECT_PATH = "../"  # Cambiado para apuntar al directorio raíz del repo desde app/
...
def main():
    ...
    try:
        # Inicializar pipeline con ruta corregida
